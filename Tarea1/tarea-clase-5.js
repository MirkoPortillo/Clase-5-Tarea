...
$botonCalcular.onclick = function(){
    ...
    let calcularSalario = salarioAnual/MESES_DEL_ANIO

    if(calcularSalario === 0){

      document.querySelector('#salario-mensual').value = 'No ingresaste ningun numero'
        
    }else{

      document.querySelector('#salario-mensual').value = (`Tu salario mensual es de ${calcularSalario}`)
